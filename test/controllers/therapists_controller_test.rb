...
class TherapistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create therapist" do
    assert_difference('Therapist.count') do
      post therapists_url, params: { therapist: { email: @therapist.email, first_name: @therapist.first_name, last_name: @therapist.last_name, password_digest: @therapist.password_digest, prefix: @therapist.prefix, profession: @therapist.profession } }
    end
